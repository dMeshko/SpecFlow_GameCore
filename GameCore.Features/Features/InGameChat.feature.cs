...
namespace GameCore.Features.Features
{
    ...
    [Xunit.TraitAttribute("Category", "awaitingReview")]
...
#line hidden
        ...
        public InGameChatFeature(InGameChatFeature.FixtureData fixtureData, GameCore_Features_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "InGameChat", "In order to increase the sense of game community\nAs a human player\nI want to be a" +
                    "ble to chat via text with other human players", ProgrammingLanguage.CSharp, new string[] {
                        "awaitingReview"});
        ...
        public virtual void ChatMessagesLimitedInLength()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Chat messages limited in length", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
...
#line hidden
#line 9
        testRunner.When("I try to send it", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 10
...
#line hidden
        ...
        public virtual void ChatMessagesAreNotOffensive()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Chat messages are not offensive", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 13
    this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
